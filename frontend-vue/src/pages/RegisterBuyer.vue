...
<template>
  <div class="relative min-h-screen bg-black text-white overflow-hidden flex items-center justify-center">
    ...
    <div class="relative z-20 -mt-20 flex flex-col items-center justify-center w-full min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div
        class="max-w-2xl w-full p-8 rounded-2xl shadow-lg  bg-zinc-900 bg-opacity-90"
      >
      <h1 class="text-center mb-5 text-3xl z-[5]">Регистрация покупателя</h1>
        <form class="space-y-6" @submit.prevent="submit">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <!-- Role selection removed for buyer registration -->
          </div>
          ...
          <div class="text-center text-sm text-gray-400">
            Вы продавец?
            <router-link to="/register/seller" class="text-[#FFF] p-2 px-4 hover:bg-[#5900AC]/70 rounded-2xl "
              >Регистрация Продавца</router-link
            >
          </div>
        </form>
      </div>
